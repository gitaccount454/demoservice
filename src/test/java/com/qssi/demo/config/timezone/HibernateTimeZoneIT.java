package com.qssi.demo.config.timezone;

import com.qssi.demo.DmeoappApp;
import com.qssi.demo.config.SecurityBeanOverrideConfiguration;
import com.qssi.demo.repository.timezone.DateTimeWrapper;
import com.qssi.demo.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, DmeoappApp.class})
